...
conformal.drop.roo = function(x, y, train.fun, predict.fun, vars=0,
  ...
  for (k in 1:2) {
    ...
    for (j in 1:nv) {
      ...
      # Get the convormal intervals for differences in the residuals
      a = convormal.diff.int(pred[i2,,drop=F],pred.j,
